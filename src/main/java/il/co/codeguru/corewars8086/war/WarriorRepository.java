...
public class WarriorRepository {
    ...
    public void readZombiesFileFromPath(String path) throws IOException {
        ...
        for (File file : zombieFiles) {
            ...
            WarriorData data = readWarriorFile(file, true);
    ...
    public void readWarriorsFileFromPath(String path) throws IOException {
        ...
        for (File file : warriorFiles) {
            ...
            WarriorData data = readWarriorFile(file, false);
            if (name.endsWith("1")) {
                // start a new group!
    ...
    private static WarriorData readWarriorFile(File filename, boolean zombie) throws IOException {
        ...
        return new WarriorData(warriorName, warriorData, zombie);
    }
